...
#if DEBUG
        private static readonly string baseUri = "http://localhost:8080";
#else
		private static readonly string baseUri = "https://mediatekdocuments.vinceh121.me";
#endif

        private static readonly string imageUri = baseUri + "/content/";

        /// <summary>
        /// adresse de l'API
        /// </summary>
        private static readonly string uriApi = baseUri + "/api/v1/";
        /// <summary>
