...
if (!isset($_SERVER['PHP_AUTH_USER']) || (isset($_SERVER['PHP_AUTH_USER']) && !(($_SERVER['PHP_AUTH_USER'] == 'admin' && ($_SERVER['PHP_AUTH_PW'] == 'adminpwd'))))) {
    ...
    $champs = filter_input(INPUT_GET, 'champs', FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES) ?? filter_input(INPUT_POST, 'champs', FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
